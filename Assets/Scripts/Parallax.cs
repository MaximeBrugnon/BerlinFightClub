...
{
    [SerializeField] [Range(-1f, 2f)] float _lagAmount = 0f;
    ...
    private void LateUpdate()
    {
        ...
        _targetPosition = new Vector3(transform.position.x + movement.x * ParallaxAmount, transform.position.y + movement.y / 3 * ParallaxAmount, transform.position.z);
